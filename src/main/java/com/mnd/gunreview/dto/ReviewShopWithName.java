...
public class ReviewShopWithName {
	private int no;
	...
	public ReviewShopWithName() {
	}

	public ReviewShopWithName(int no, String review_content, Date review_datetime, String review_img,
			double review_rate, String review_userid, String review_nickname, Date review_birth, String shop_id,
			String place_name) {
		super();
		this.no = no;
