...
public class Shop {
	...
	public Shop(String id, String phone, String place_name, String address_name, String road_address_name,
			String lat, String lng, String category_group_code, String category_group_name, String place_url,
			String discount) {
		super();
		this.id = id;
		this.phone = phone;
