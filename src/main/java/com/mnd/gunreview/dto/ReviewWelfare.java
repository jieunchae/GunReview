...
public class ReviewWelfare {
	...
	public ReviewWelfare(int no, String review_content, Date review_datetime, String review_img, double review_rate,
			String review_userid, String review_nickname, Date review_birth, String welfare_id) {
		super();
		this.no = no;
		this.review_content = review_content;
		this.review_datetime = review_datetime;
